//Cambio de Color para Match Game
...
//Para las imagenes en las columnas
...
//Que imagenes iguales coincidan en las columnas
...
//Para que imagenes iguales coincidan en las filas
...
//Para llenar el cuadro con las imagenes
function llenarTablero() {
  ...
  column.each(function() {
    ...
    for (var i = 0; i < agrega; i++) {
      //Para agregar imagen al azar
      var candyType = getRandomInt(1, 5);
      //Para que si el espacio esta vacio se llene
      if (i == 0 && candys < 1) {
        $(this).append('<img src="image/'+candyType+'.png" class="element"></img>');
      } else {
        //Para que caigan las imagenes al espacio vacio
...
//Para que una sola imagen no se mueva
...
//Para que cambie una imagen por otra al colocarlo encima
...
function llenarTableroPromise(result) {
  if (result) {
    llenarTablero();
  }
}

//Para calcular la cantidad de movimientos
...
//Para titileo al borrar las imagenes
...
//Para el Boton de Inicio
  $('.btn-reinicio').click(function() {

    //Para que reinicie el juego al presionar dos veces
    ...
    //Para iniciar los efectos en el titulo
